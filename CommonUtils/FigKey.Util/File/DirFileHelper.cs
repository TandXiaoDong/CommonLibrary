...
namespace FigKey.Util
{
    ...
    public static class DirFileHelper
    {
        ...
        public static void CreateFile(string dir, string pagestr)
        {
            ...
            System.IO.StreamWriter sw = new System.IO.StreamWriter(System.Web.HttpContext.Current.Request.PhysicalApplicationPath + "\\" + dir, false, utf8);
            sw.Write(pagestr);
            sw.Close();
        }
        /// <summary>
