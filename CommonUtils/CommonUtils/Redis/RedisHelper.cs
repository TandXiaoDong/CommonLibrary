...
namespace CommonUtils.Redis
{
    ...
    public static class RedisHelper
    {
        ...
        /// <returns></returns>
        private static PooledRedisClientManager CreateRedisManager(IEnumerable<string> readWriteHosts,IEnumerable<string> readOnlyHosts)
        {
            //支持读写分离，均衡负载
