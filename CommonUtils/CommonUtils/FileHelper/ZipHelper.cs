...
namespace CommonUtils.FileHelper
{
    public static class ZipHelper
    {
        ...
        {
            string commonString = "";
            MemoryStream ms = new MemoryStream(Convert.FromBase64String(param));
        ...
        public static bool ZipDirectory(string folderToZip, string zipedFile, string password)
        {
            ...
            FileStream stream = new FileStream(zipedFile, FileMode.OpenOrCreate);
        ...
        private static bool ZipDirectory(string folderToZip, ZipOutputStream zipStream, string parentFolderName)
        {
            ...
            foreach (string folder in Directory.GetDirectories(folderToZip))
            {
